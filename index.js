...
client.on('ready', () => {
  console.log('켰다.');
  client.user.setPresence({ game: { name: '필연 관리자에게 문의하세요.' }, status: 'online' })
});
...
client.on('message', (message) => {
  ...
  if(message.content == '!si') {
    ...
    embed.setAuthor('server info of 필연 BOT', img)
    embed.setFooter(`필연 BOT ❤️`)
    embed.addBlankField()
  ...
  if(message.content == 'embed') {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setAuthor('필연', img, 'http://www.naver.com')
      .setThumbnail(img)
      .addBlankField()
    ...
    let commandStr = '';
    let embed = new Discord.RichEmbed()
      .setAuthor('Help of 필연 BOT', helpImg)
      .setColor('#186de6')
      .setFooter(`필연 BOT ❤️`)
      .setTimestamp()
